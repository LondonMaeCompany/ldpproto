<footer class="footer" id="footer">
      <div  id="footer-check"  class="footer__main footer__main_mod-a parallax-bg parallax-dark footer-small">
  ...
  <!-- end layout-theme-->
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="contactpopup" tabindex="-1">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
						<form class="support-ticket-form">
					  		<h3 class="ui-title-inner-1 ui-title-inner-1_light">Contact Us</h3>
						  <div class="row">
