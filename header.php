    ...
    <header class="header header_mod-a animated fadeIn"> 
    	<div class="visible-xs navbar-fixed-top mobile-header">
			<a class="navbar-brand logo space trn800ms" href="#">  
				<img src="assets/media/general/logo-resized2.png" alt="Logo" class="logo__img2 img-responsive2 trn500ms" />
			</a>  
		  ...
		  <div class="container-fluid no-left-padding">      
			...
			<div class="collapse2 navbar-collapse2">
			  <ul class="nav navbar-nav navbar-left">
                      ...
                      <li><a class="trn500ms" href="about.html">Who We Are</a></li>  
                      <li class="dropdown"><a class="trn500ms" href="services.html">What We Offer</a>
			  ...
			  <ul class="nav navbar-nav navbar-right">
                      <li class="dropdown"><a class="trn500ms" href="support.html">Software & Support</a>
                        <ul role="menu" class="dropdown-menu">
                          <li><a class="trn500ms" href="support.html">Software Downloads</a></li>
